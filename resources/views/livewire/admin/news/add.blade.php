...
<div class="text-end">
    <button class="btn btn-primary mb-3" data-bs-toggle="modal" data-bs-target="#addNews">
        เพิ่มข้อมูล
    </button>
</div>
...
<div class="modal fade" id="addNews" data-bs-backdrop="static" tabindex="-1" aria-labelledby="exampleModalLabel"
            ...
            <form wire:submit.prevent="submit">
                <div class="modal-body">
                    ...
                    <div class="mb-2">
                        ...
                        <textarea class="form-control {{ $errors->has('descript') ? 'is-invalid' : null }}" wire:model="descript"
